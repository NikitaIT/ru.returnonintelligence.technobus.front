...
// license : MIT
// http://quelicoto.es
var GoogleSpreadsheet = function (e) {
	...
	function n() {}
	var t = {};
	n.prototype.getGoogleUrl = function () {
		return t
	};
	n.prototype.url = function (e) {
		t = this.getGoogleUrl();
		t.sourceIdentifier = e;
		if (t.sourceIdentifier.match(/http(s)*:/)) {
			t.url = t.sourceIdentifier;
			try {
				t.key = t.url.match(/key=(.*?)&/)[1]
			} catch (n) {
				t.key = t.url.match(/(cells|list)\/(.*?)\//)[2]
			}
			try {
				if(t.url.match(/gid=(.*)/)!==null){
					t.gid = gid_to_wid(t.url.match(/gid=(.*)/)[1]);
				}else{
					t.gid = gid_to_wid("0");
				}
			} catch (n) {
				console.error("gid error");
			}
		} else {
			t.key = t.sourceIdentifier
		}
		t.jsonCellsUrl = "https://spreadsheets.google.com/feeds/cells/" + t.key + "/" + t.gid + "/public/basic?alt=json-in-script";
		t.jsonListUrl = "https://spreadsheets.google.com/feeds/list/" + t.key + "/" + t.gid + "/public/basic?alt=json-in-script"
	};
	n.prototype.load = function () {
		var e = arguments;
		var t = this;
		if (e.length > 1 && e[0] === "cell") {
			this.loadCells().then(function (n) {
				return e[1](t.loadDataCells(n))
			})
		} else {
			this.loadList().then(function (n) {
				return e[0](t.loadDataList(n))
			})
		}
	};
	n.prototype.loadCells = function (n) {
		t = this.getGoogleUrl();
		n = t.jsonCellsUrl + "&callback=?";
		return e.getJSON(n)
	};
	n.prototype.loadList = function (n) {
		t = this.getGoogleUrl();
		n = t.jsonListUrl + "&callback=?";
		return e.getJSON(n)
	};
	n.prototype.loadDataCells = function (e) {
		var t;
		var n, r, i, s;
		i = e.feed.entry;
		s = [];
	...
	n.prototype.loadDataList = function (t) {
		var n, r, i;
		var s, o, u, a;
		u = t.feed.entry;
		a = {};
...
function getLanguage(e){$.getJSON("lang/"+e+".json",function(e){$.each(e,function(e,t){$("[name = "+e+"]").html(t)})})}function initSlick(){$(".timetable__row--subrow").slick({arrows:!1,dots:!1,infinite:!1,variableWidth:!0,speed:200,slidesToScroll:7,responsive:[{breakpoint:1024,settings:{slidesToScroll:4}},{breakpoint:600,settings:{slidesToScroll:4}},{breakpoint:480,settings:"unslick"}]})}$(function(){$(".russian").button("toggle"),$(".russian").click(function(){getLanguage("ru"),$("#map").attr("lang","ru")}),$(".russian").click(),$(".english").click(function(){getLanguage("en"),$("#map").attr("lang","en")}),$(".lang").addClass("btn-group-vertical"),$(".lang").removeClass("btn-group"),$(".to_technopolis").button("toggle"),$(".to_technopolis").click(function(){$("#route0").css("visibility","visible"),$("#route0").css("position","initial"),$("#route1").css("visibility","hidden"),$("#route1").css("position","absolute")}),$(".from_technopolis").click(function(){$("#route0").css("visibility","hidden"),$("#route0").css("position","absolute"),$("#route1").css("visibility","visible"),$("#route1").css("position","initial")})}),$(function(){function e(){var e={hour:"numeric",minute:"numeric"},t=new Date,o=t.toLocaleString("ru",e)+" ",n=function(e){return["sunday","monday","tuesday","tednesday","thursday","friday","saturday"][e.getDay()]}(t);$(".day").attr("name",n),$("time.current-time").html(o)}e(),setInterval(e,9e3)}),$(function(){function e(){function e(e,t){ymaps.route([{point:e,type:"viaPoint"},t]).then(function(e){s.geoObjects.add(r=e)},function(e){alert("Возникла ошибка: "+e.message)})}function t(){c.isSelected()&&(r&&s.geoObjects.remove(r),e(n,i))}var o={metro:[59.853876,30.321102],technopolis:[59.818043,30.327938],metro1:[59.850127,30.321772],routeCenter:[59.835681,30.322253]},n=o.metro,i=o.technopolis,s=new ymaps.Map("map",{center:o.metro,zoom:16},{searchControlProvider:"yandex#search"}),a=new ymaps.Placemark(s.getCenter());s.geoObjects.add(a);var r,c=new ymaps.control.Button('<div name="route_show">Показать маршрут</div>');c.events.add("select",function(){e(n,i),s.setZoom(12),s.setCenter(o.routeCenter),c.data.set("content",'<div name="route_hide"></div>'),getLanguage($("#map").attr("lang"))}).add("deselect",function(){r&&s.geoObjects.remove(r),c.data.set("content",'<div name="route_show"></div>'),getLanguage($("#map").attr("lang"))}),s.controls.add(c,{float:"left",maxWidth:"auto"}),a.events.add("mouseenter",function(e){e.get("target").options.set("preset","islands#greenIcon")}).add("mouseleave",function(e){e.get("target").options.unset("preset")}),$("#from").click(function(){s.setCenter(o.technopolis),a.geometry.setCoordinates(s.getCenter()),n=o.technopolis,i=o.metro1,t(),s.setZoom(16)}),$("#to").click(function(){s.setCenter(o.metro),a.geometry.setCoordinates(s.getCenter()),n=o.metro,i=o.technopolis,t(),s.setZoom(16)})}ymaps.ready(e)}),$(function(){function e(e,t,o){function n(e){var t="";for(var o in e)void 0!==s[o]&&(t+='<div  class="timetable__min day'+e[o]+'">'+e.id+":"+s[o]+"</div>");return t}var i="",s={b:"00",c:"05",d:10,e:15,f:20,g:25,h:30,i:35,j:40,k:45,l:50,m:55};i+='<div class="timetable__row__current" id="route'+o+'">',e.items.forEach(function(e,t,o){var s=n(e);""!==s&&(i+='<div class="timetable__row"><div class="timetable__hover ">'+e.id+'</div><hr class="line"/><div class="timetable__row--subrow">'+s+"</div></div>")}),i+="</div>",$(t).append(i)}var t="https://docs.google.com/spreadsheet/pub?key=1VwgzSFxVRu2Z-9tvF8wimO2m3BmuW4ngcST5uGSRYRg&output=html",o=new GoogleSpreadsheet;o.url(t),o.load(function(t){console.log(t),e(t,".timetable__row__all",0)});var o=new GoogleSpreadsheet;o.url(t+"&gid=1453141125"),o.load(function(t){console.log(t),e(t,".timetable__row__all",1)}),setTimeout(initSlick,1e3),getLanguage("ru")});