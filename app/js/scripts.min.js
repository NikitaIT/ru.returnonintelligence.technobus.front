...
var GoogleSpreadsheet = function (e) {
	...
	n.prototype.url = function (e) {
		...
		t.jsonCellsUrl = "http://spreadsheets.google.com/feeds/cells/" + t.key + "/" + t.gid + "/public/basic?alt=json-in-script";
		t.jsonListUrl = "http://spreadsheets.google.com/feeds/list/" + t.key + "/" + t.gid + "/public/basic?alt=json-in-script"
	};
